...
<header
	class="fixed left-0 top-0 z-50 w-full -translate-y-4 animate-fade-in border-b backdrop-blur-2xl"
>
	<!-- {#if innerWidth < 768} -->
	<div class="graphext-logo container flex h-14 items-center justify-between font-bold">
		<a class="text-md flex items-center" href="/"> Graphext </a>

		<div class="ml-auto flex h-full items-center">
			<a class="mr-6 text-sm" href="https://accounts.graphext.com/users/sign_in"> Log in </a>
			<Button
				variant="secondary"
				class="mr-6 text-sm"
				href="https://accounts.graphext.com/users/sign_up">Sign up</Button
			>
		</div>
